                                        ...
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap flex justify-between items-center">
                                                ...
                                                @if ($user->isUserCurrentlyAuthenticated())
                                                    <span
                                                        class="px-2 inline-flex text-sm leading-5 font-semibold rounded-full border border-gray-400 text-gray-800">You</span>
                                                @endif
                                            </td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                @if ($user->is_admin)
                                                    <span
                                                        class="px-2 inline-flex text-sm leading-5 font-semibold rounded-full bg-green-100 text-green-800">Admin</span>
                                                @endif
                                                @if ($user->is_team_member)
                                                    <span
                                                        class="px-2 inline-flex text-sm leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">Team
                                                        Member</span>
                                                @endif
                                            </td>
