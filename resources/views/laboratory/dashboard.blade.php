<x-hops.layout>
    <x-slot:title>{{ __('Laboratory Dashboard') }}</x-slot:title>
    ...
    <div class="relative w-full bg-white py-12 px-4 sm:px-6 lg:px-8 border-b border-hops-light overflow-hidden">
        ...
        <div class="relative max-w-4xl mx-auto text-center">
            ...
            <p class="text-sm text-gray-500 text-center mt-2 max-w-xl mx-auto">
                {{ __('Entry point for team members to analyze persistent agendas, compare custom similarity weights, and inspect historical engine responses.') }}
            </p>
        </div>
    </div>
